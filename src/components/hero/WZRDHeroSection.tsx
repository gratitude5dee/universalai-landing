...
const WZRDHeroSection: React.FC = () => {
  ...
  return <>
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Light Rays Effect */}
        <LightRays count={5} color="hsl(210 100% 50% / 0.12)" blur={60} speed={14} length="70vh" />
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-16 sm:pb-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-6 sm:mb-8">
              <TextAnimate animation="blurInUp" by="word" once className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-black leading-[1.1] tracking-tight bg-gradient-to-r from-primary via-primary/80 to-accent bg-clip-text text-transparent" duration={1.5}>
              ...
              duration: 0.6
                ...
                <AnimatedGradientText colorFrom="hsl(210 100% 60%)" colorTo="hsl(40 100% 60%)" speed={1.2} className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold">
            ...
            <ShimmerButton onClick={() => setWaitlistOpen(true)} shimmerColor="hsl(210 100% 70%)" background="hsl(var(--primary))" borderRadius="16px" shimmerDuration="2.5s" className="w-full sm:w-auto font-bold px-8 sm:px-10 h-[52px] text-base sm:text-lg">
              Join Waitlist
              <ArrowRight className="ml-2 w-5 h-5" />
            </ShimmerButton>
            <Button onClick={scrollToManifesto} variant="outline" size="lg" className="w-full sm:w-auto glass-liquid border-border/30 hover:border-primary/40 px-8 sm:px-10 h-[52px] text-base sm:text-lg rounded-2xl font-semibold touch-manipulation">
              Read Manifesto
            </Button>
            </motion.div>
