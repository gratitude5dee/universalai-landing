...
const ManifestoSection: React.FC = () => {
  ...
  return <section id="manifesto" className="py-24 md:py-32 relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <div ref={ref} className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-10">
            {dimensions.map((dim, index) => <motion.div key={dim.label} initial={{
            opacity: 0,
            scale: 0.8
          }} animate={inView ? {
            opacity: 1,
        ...
        <div className="relative rounded-[2rem] overflow-hidden">
            <ShineBorder shineColor={["hsl(210 100% 50%)", "hsl(280 100% 60%)", "hsl(40 100% 50%)"]} duration={8} borderWidth={2} />
              ...
              <div className="relative space-y-10">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed text-base md:text-lg pl-6">
                    ...
                    across dimensions you haven't imagined yet. <span className="text-primary font-medium">Time for acceleration.</span>
                  </p>
                </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            return <motion.div key={product.name} initial={{
              opacity: 0,
              y: 30
            }} whileInView={{
              opacity: 1,
                  ...
                  <div className="relative h-full rounded-2xl glass-liquid border border-white/5 hover:border-white/10 p-6 transition-all duration-300 overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${product.bgGradient} border border-white/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                        <Icon className={`w-6 h-6 bg-gradient-to-r ${product.gradient} bg-clip-text`} style={{
                      color: 'transparent',
