...
const BottomStats = () => {
  ...
  const revenue = useCountUp({ end: 2.3, duration: 2500, decimals: 1, prefix: '$', suffix: 'M+' });
  const creators = useCountUp({ end: 10000, duration: 2500, suffix: '+', separator: ',' });
  const success = useCountUp({ end: 98, duration: 2000, suffix: '%' });

  React.useEffect(() => {
    if (inView) {
      revenue.triggerAnimation();
      creators.triggerAnimation();
      success.triggerAnimation();
    }
  }, [inView]);
    ...
    >
      <GlassmorphicCard className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="text-4xl font-bold text-primary mb-2">{revenue.value}</div>
          ...
          >
            <div className="text-4xl font-bold text-primary mb-2">{creators.value}</div>
          ...
          >
            <div className="text-4xl font-bold text-primary mb-2">{success.value}</div>
