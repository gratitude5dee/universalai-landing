        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[85vh] sm:min-h-[80vh] mt-0 sm:-mt-[20px] lg:-mt-[50px] py-8 sm:py-0">
          ...
          <div className="flex flex-col justify-center text-center lg:text-left order-2 lg:order-1">
            ...
            <motion.div 
              ...
              className="relative inline-flex items-center gap-2 glass border border-primary/30 rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-6 sm:mb-8 mt-[90px] self-center lg:self-start text-center hover:border-primary/50 transition-all duration-300 group overflow-hidden"
            >
              {/* Pulse Ring Effect */}
              <motion.div
